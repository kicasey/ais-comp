...
/// <summary>
/// Chat API for AI assistant. Proxies to resume-api when configured.
/// For employee presets (match_roles, etc.), requires a resume on the user's profile and passes it to the API.
/// </summary>
[ApiController]
...
public class ChatController : ControllerBase
{
    ...
    private static string GetFallbackResponse(ChatRequest request)
    {
        ...
        return "The AI assistant could not be reached. Check that ResumeApi:BaseUrl points to resume-api.campbellthompson.com and that the API is running.";
    }
